...
export const metadata: Metadata = {
  title: 'מריאטה פנחסי - משרד עורכי דין ונוטריון | הסכמי מכר, ליקויי בניה, צוואות',
  description: 'משרד עורכי דין ונוטריון מנוסה. הסכמי מכר ורכישה, תביעות ליקויי בניה, איחור במסירה, סכסוכי שכנים, צוואות ושירותי נוטריון. שירות בכל הארץ',
