...
export const metadata: Metadata = {
    ...
    description: 'נוטריון מוסמך במרכז הארץ וגוש דן. אימות חתימה, ייפוי כוח נוטריוני, אישור העתק נאמן למקור, תרגום נוטריוני וצוואות. שירות מהיר במשרד או עד הבית. אור יהודה, קריית אונו, תל אביב, רמת גן והמרכז.',
    keywords: 'נוטריון, נוטריון מרכז, נוטריון גוש דן, אימות חתימה נוטריון, ייפוי כוח נוטריוני, תרגום נוטריוני, אישור נוטריון, העתק נאמן למקור, נוטריון אור יהודה, נוטריון קריית אונו, נוטריון תל אביב, נוטריון רמת גן, מריאטה פנחסי',
    alternates: {
        canonical: 'https://www.marietta-law.co.il/services/notary',
    },
    openGraph: {
...
export default function NotaryPage() {
    ...
    const faqs = [
        ...
        {
            question: "מה ההבדל בין אישור נוטריוני לאימות חתימה אצל עורך דין?",
            answer: "אימות חתימה אצל עורך דין מתאים למסמכים מסוימים בלבד. אישור נוטריוני הוא בעל מעמד משפטי גבוה יותר ומוכר בכל העולם - הנוטריון מאמת את זהות החותם, את כשירותו ואת רצונו החופשי. מסמכים רבים (לחו\"ל, לבנקים, לרשויות) דורשים דווקא אישור נוטריוני, ולא אימות חתימה רגיל."
        },
        {
            question: "האם צריך אפוסטיל על אישור נוטריוני לחו\"ל?",
            answer: "ברוב המקרים כן. מסמך נוטריוני המיועד לשימוש במדינה זרה דורש בדרך כלל חותמת אפוסטיל ממשרד המשפטים (ולעיתים אישור נוסף ממשרד החוץ או משגרירות). אנו נדריך אתכם בדיוק אילו אישורים נדרשים עבור היעד הספציפי שלכם."
        },
        {
            question: "האם אתם מספקים שירותי נוטריון בכל אזור המרכז?",
            answer: "המשרד ממוקם באור יהודה ומשרת לקוחות מכל גוש דן והמרכז - קריית אונו, יהוד-מונוסון, גני תקווה, תל אביב, רמת גן, גבעתיים, סביון, פתח תקווה ועוד. במקרים של מוגבלות או דחיפות אנו מציעים גם שירות נוטריון עד הבית בתיאום מראש."
        }
    ]
            ...
            <section className="py-20 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">שירותי נוטריון במרכז הארץ — מה חשוב לדעת</h2>
                        <p className="mb-6">
                            נוטריון הוא עורך דין בעל ותק וניסיון שהוסמך על ידי משרד המשפטים לאמת, לאשר ולערוך מסמכים בעלי תוקף משפטי מיוחד.
                            אישור נוטריוני נחשב לראיה מוצקה בבית המשפט ומוכר גם במדינות זרות. עו"ד מריאטה פנחסי היא נוטריון מוסמכת
                            המעניקה את מלוא שירותי הנוטריון לתושבי אור יהודה, קריית אונו וכל אזור גוש דן והמרכז.
                        </p>

                        <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">השירותים הנוטריוניים הנפוצים</h3>
                        <ul className="list-disc pr-6 space-y-2 mb-6">
                            <li><strong>אימות חתימה:</strong> על ייפויי כוח, הסכמים, הצהרות ומסמכים למשכנתא.</li>
                            <li><strong>אישור העתק נאמן למקור:</strong> לתעודות ומסמכים רשמיים.</li>
                            <li><strong>תרגום נוטריוני:</strong> אישור נכונות תרגום לתעודות לידה, נישואין, לימודים ומסמכים לחו"ל.</li>
                            <li><strong>ייפוי כוח מתמשך:</strong> כלי חשוב לתכנון עתידי – ראו את <Link href="/blog/enduring-power-of-attorney" className="text-amber-600 font-semibold hover:underline">המדריך לייפוי כוח מתמשך</Link>.</li>
                            <li><strong>צוואה נוטריונית:</strong> צוואה בעלת תוקף מוגבר, "צוואה בפני רשות".</li>
                        </ul>

                        <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">כמה זה עולה? התעריף קבוע בחוק</h3>
                        <p className="mb-6">
                            יתרון חשוב: שכר הטרחה של נוטריון <strong>קבוע בתקנות ואחיד לכל הנוטריונים בישראל</strong> – אסור לגבות יותר או פחות.
                            התעריף מתעדכן מדי שנה (בדרך כלל בינואר) ותלוי בסוג האישור, מספר החותמים ומספר העותקים. כך שאתם משלמים בדיוק את אותו מחיר בכל מקום,
                            וההבדל הוא רק ברמת השירות, הזמינות והמהירות.
                        </p>

                        <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">מסמכים לחו"ל ואפוסטיל</h3>
                        <p className="mb-6">
                            מסמך נוטריוני המיועד לשימוש במדינה זרה דורש בדרך כלל חותמת <strong>אפוסטיל</strong> ממשרד המשפטים.
                            אנו מלווים את כל התהליך – מהאישור הנוטריוני ועד ההנחיה לקבלת האפוסטיל – כדי שהמסמך יתקבל ביעד ללא תקלות.
                            זקוקים גם לליווי בעסקת נכס? ראו את עמוד <Link href="/services/real-estate" className="text-amber-600 font-semibold hover:underline">עורך דין נדל"ן</Link>.
                        </p>
                    </article>
                </div>
            </section>
