                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "mainEntity": [
                            ...
                            {
                                "@type": "Question",
                                "name": "כמה עולה עורך דין למכירת דירה יד שנייה?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "בעסקת מכירה של דירת יד שנייה שכר הטרחה נוטה להיות בקצה התחתון של הטווח (סביב 0.5% מהתמורה בתוספת מע\"מ), משום שהעבודה בצד המוכר ממוקדת יותר. כשיש מורכבות מס שבח או מספר בעלים המחיר עולה בהתאם. תמיד בקשו הצעת מחיר בכתב הכוללת מע\"מ."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "האם שכר הטרחה בקנייה שונה מהמכירה?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "כן. בצד הקונה עורך הדין מבצע את עיקר העבודה (בדיקות מקדימות, הגנה על התשלומים, רישום זכויות), ולכן שכר הטרחה בקנייה נוטה להיות גבוה מעט מאשר במכירה. בקנייה מקבלן, המורכבות הנוספת עשויה להעלות את המחיר עוד."
                                }
                            }
                        ]
                    })
            ...
            <section className="py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 article-content text-lg text-gray-800 leading-relaxed space-y-8">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">שכר טרחה עורך דין לפי סוג עסקה</h2>
                        <p>
                            שכר הטרחה משתנה בהתאם לסוג העסקה ולצד שאתם בו. הנה פירוט לפי המקרים הנפוצים:
                        </p>

                        <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">שכר טרחה עורך דין בקניית דירה</h3>
                        <p>
                            בקניית דירה עורך הדין מבצע את עיקר העבודה: בדיקות מקדימות, בדיקת החוזה, הגנה על התשלומים
                            ורישום הזכויות על שמכם. לכן שכר הטרחה בצד הקונה נוטה להיות בקצה הגבוה של הטווח (כ-0.75%-1.5%).
                            בקניית דירה מקבלן, המורכבות (ערבויות חוק המכר, מפרט) עשויה להעלות את המחיר.
                        </p>

                        <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">שכר טרחה עורך דין במכירת דירה</h3>
                        <p>
                            בצד המוכר העבודה ממוקדת יותר (ניסוח/בדיקת החוזה, תכנון וטיפול במס שבח, הסרת שעבודים ומשכנתא),
                            ולכן שכר הטרחה נוטה להיות מעט נמוך יותר מאשר בצד הקונה. עם זאת, כשיש מורכבות מס או מספר בעלים -
                            המחיר עולה בהתאם.
                        </p>

                        <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">שכר טרחה עורך דין בעסקת יד שנייה</h3>
                        <p>
                            עסקת יד שנייה "רגילה" (דירה מיחיד, בלי מורכבויות) היא לרוב הזולה ביותר - בקצה התחתון של הטווח.
                            עדיין, גם בעסקה פשוטה לכאורה נדרשות כל הבדיקות המקדימות, שכן דווקא שם מתגלות לא פעם הפתעות
                            (חריגות בנייה, חובות, אי-התאמה ברישום).
                        </p>
