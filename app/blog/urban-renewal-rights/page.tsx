...
export default function UrbanRenewalRights() {
    const schemaData = {
        ...
        "description": "גרים בבניין ישן ונדבקו שלטי פינוי-בינוי? לפני שחותמים על כל מסמך — חשוב להכיר את הזכויות שלכם, מה שלח מוכר לכם הדיירים הסכם הגינוי וכיצד להתמודד עם יזמים אגרסיביים.",
