    ...
    const faqs = [
        {
            ...
            answer: "תקן 9.1 הוא תקן שמאי של מועצת שמאי המקרקעין, שנועד ליצור אחידות ובהירות בהגדרה ובדיווח של שטחים בנויים בשומות מקרקעין. הוא מחליף את תקן 9.0 משנת 2006. חשוב להדגיש: התקן אינו משנה את גודל הדירה - הוא אמור להניב אותה תוצאה מספרית כמו קודם (דירה של 100 מ\"ר נשארת 100 מ\"ר), רק עם הגדרה אחידה וברורה יותר. זהו תקן שמאי - ולא תקן ארנונה."
        },
        {
            answer: "מדובר בשלושה מקורות שמודדים אחרת: המודעה השיווקית מציגה לרוב שטח 'ברוטו' נדיב (כולל חלקים משותפים); נסח הטאבו מציג את השטח הרשום; והארנונה נמדדת לפי צו הארנונה של כל עירייה. חשוב לדעת: אין בישראל שיטת מדידה ארצית אחידה לארנונה - יש רשויות שמודדות נטו, אחרות ברוטו או ברוטו-ברוטו (כולל חלק יחסי מהשטחים המשותפים). לכן אותה דירה בדיוק עשויה לקבל שטח ארנונה שונה בשתי ערים שונות.",
            ...
            <section className="py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 article-content text-lg text-gray-800 leading-relaxed space-y-8">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">תקן 9.1 — תקן שמאי חדש להגדרת שטח (ומה הוא לא)</h2>
                        <p>
                            כדי ליצור אחידות ובהירות, אימצה מועצת שמאי המקרקעין את <strong>תקן 9.1</strong>, שמחליף את התקן
                            הקודם (9.0 משנת 2006). התקן מסדיר את <strong>ההגדרה והדיווח של שטחים בנויים בשומות מקרקעין</strong> —
                            כלומר איך שמאי מגדיר ומדווח שטח באופן אחיד וברור (למשל אופן מדידת קירות: חיצוני עד הפן הפנימי,
                            משותף עד המרכז).
                        </p>
                        <div className="bg-blue-50 p-6 rounded-xl border-r-4 border-blue-400 my-6">
                            <p className="text-gray-700">
                                <strong>חשוב להבין — תקן 9.1 אינו משנה את גודל הדירה.</strong> לפי מסמכי מועצת שמאי המקרקעין,
                                ההגדרה המעודכנת אמורה להניב את <strong>אותה תוצאה מספרית</strong> שהתקבלה לפי תקן 9.0 (דירה של
                                100 מ״ר נשארת 100 מ״ר) — המטרה היא אחידות ושקיפות, לא "ניפוח" שטח. בנוסף: זהו <strong>תקן שמאי,
                                ולא תקן ארנונה</strong> — הוא אינו קובע את שטח הדירה לצורכי ארנונה.
                            </p>
                        </div>
                        ...
                        <ul className="list-none space-y-3 pr-4">
                            {[
                                ...
                                'שטח לארנונה: נמדד לפי צו הארנונה של כל עירייה — ואין שיטה ארצית אחידה. יש רשויות שמודדות נטו, אחרות ברוטו או ברוטו-ברוטו (כולל חלק יחסי מהשטחים המשותפים) — ולכן אותה דירה יכולה לקבל שטח ארנונה שונה בערים שונות.',
                            ].map((item, i) => (
